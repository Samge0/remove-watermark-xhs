## docker of remove-watermark-xhs-dev
...
- build docker
    ```shell
    docker build . -t samge/remove-watermark-xhs-dev-base -f .devcontainer/Dockerfile-dev-base --build-arg PROXY=http://192.168.50.48:7890
    ```

- upload
    ```shell
    docker push samge/remove-watermark-xhs-dev-base
    ```
